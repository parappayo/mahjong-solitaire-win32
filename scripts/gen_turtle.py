...
triples = [tuple(map(int, m.split(","))) for m in re.findall(r"\d+,\d+,\d+", s)]
assert len(triples) == 144

print("#ifndef TURTLE_LAYOUT_H")
print("#define TURTLE_LAYOUT_H")
print("")
print("typedef struct TurtleSlot {")
print("    int x;")
print("    int y;")
print("    int z;")
print("} TurtleSlot;")
print("")
print("#define TURTLE_TILE_COUNT (144u)")
print("")
print("static const TurtleSlot kTurtleLayout[TURTLE_TILE_COUNT] = {")
for x, y, z in triples:
    print(f"    {{ {x}, {y}, {z} }},")
print("};")
print("")
print("#endif /* TURTLE_LAYOUT_H */")
